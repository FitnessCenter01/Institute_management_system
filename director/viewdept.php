...
<script src="https://cdn.datatables.net/buttons/2.2.3/js/buttons.print.min.js"></script>
  ...
  <thead>
  <div class="row"><b><h3 style="padding-left: 25px;">Accredated departments</h3></b></div><br>
    <tr>
...
<table class="table table-striped" id="myTable">
<div class="row"><b><h3 style="padding-left: 25px;">Not accredated departments</h3></b></div><br>
  <thead>
    <tr>
