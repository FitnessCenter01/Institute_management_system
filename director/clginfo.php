...
if(!isset($_SESSION['uid'])){
  ...
  // $regsql=mysqli_query($con,"select * from `director` where `email`='$useremai'");
...
<script src="https://cdn.datatables.net/buttons/2.2.3/js/buttons.print.min.js"></script>
  ...
  <tbody>
      <?php
      $i=0;
        $sqldb=mysqli_query($con,"select * from `institute_details` where `regional_office`='$region'");
  ...
  <tbody>
    <tr>
      ...
      <td>
<?php
$sqlgov=mysqli_query($con,"select * from `institute_details` where `government`='Yes' and `regional_office`='$region'");
...
?>
    ...
    <tr>
      ...
      <td>
      <?php
$sqlauto=mysqli_query($con,"select * from `institute_details` where `autonomous`='Yes' and `regional_office`='$region'");
...
?>
    ...
    <tr>
      ...
      <td>
      <?php
$sqlautog=mysqli_query($con,"select * from `institute_details` where `governmentaided`='Yes' and `regional_office`='$region'");
...
?>
    ...
    <tr>
      ...
      <td>    <?php
$sqlautogp=mysqli_query($con,"select * from `institute_details` where `private`='Yes' and `regional_office`='$region'");
...
?></td>
    ...
    <tr>
      ...
      <td> <?php
$sqlautogpa=mysqli_query($con,"select * from `institute_details` where `accredations`='Yes' and `regional_office`='$region'");
...
?></td>
    ...
    <tr>
      ...
      <td>
      <?php
$sqlautogpan=mysqli_query($con,"select * from `institute_details` where `accredations`='No' and `regional_office`='$region'");
...
$deptregoff=mysqli_query($con,"select * from `institute_details` where `regional_office`='$region'");
...
while($rowinst=mysqli_fetch_array($sqlautogpa)){
 ...
 //echo  $No_of_vacant_post_for_hoddb=$rowinst['department_name']." | ".$rowinst['No_of_vacant_post_for_hod']."
 echo "<br>";
...
$deptregoff1=mysqli_query($con,"select * from `institute_details` where `regional_office`='$region'");
