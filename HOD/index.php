...
$pass=mysqli_real_escape_string($con,$pass);
        ...
        $sql=mysqli_query($con,"select * from `hod` where `email`='$email' and `pass`='$pass'");
            ...
            <div class="card-body p-5">
              ...
              <form method="POST" action="">
                ...
                <div class="d-flex justify-content-center">
                  <input type="submit" type="submit" name="submit" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">
                </div>
